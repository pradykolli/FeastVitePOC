    ...
    */
    ...
    override func tableView(_ tableView: UITableView, commit editingStyle: UITableViewCell.EditingStyle, forRowAt indexPath: IndexPath) {
        if editingStyle == .delete {
            ...
            ContactModelManager.shared.deleteContact(ContactModelManager.shared.contactsArray[indexPath.row])
            ContactModelManager.shared.contactsArray.remove(at: indexPath.row)
